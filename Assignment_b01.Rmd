...
# Since this function is designed to tell the user about their car mpg,
# A vector will not work in the imput
```

### Testing Function

```{r}
# petrol should not equal diesel
testthat()
# 33 mpg for petrol should equal 167.37
```
